...
def send_request(cookies):
    ...
    headers = {
        ...
        "referer": "https://thunderclap.com/free-instagram-followers",
    ...
    payload = {
        "servicePackageId": "413",
        "ReurnPage": "false",
        "usernameOrProfileUrl": "https://www.instagram.com/herl4mbang/",
        "email": "herlambang@usbc.be"
    }
    try:
